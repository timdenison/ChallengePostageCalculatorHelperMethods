<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ChallengePostageCalculatorHelperMethods.Account.OpenAuthProviders" %>
